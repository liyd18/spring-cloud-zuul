...
public class Constant {
	...
	public static final int JWT_APP_TTL = 15*24*60*60*60*1000;  //millisecond
	public static final int JWT_CLIENT_TTL = 24*60*60*60*1000;  //millisecond
